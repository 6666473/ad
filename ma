...
for n in range(100000):
    ...
    nmbr = random.randint(40838859963, 51827232195)
...
def action():
    ...
    if bch =='':
        ...
        os.system("clear")
        print (logo)
        print("\033[1;93m175,.,191, 5, 1000, 194, 195, 196, 197, 198, 199")
        try:
        ...
        os.system("clear")
        print (logo)
        print("44, 815, 315, 256, 401, 718, 917, 202, 701, 303, 703, 803, 999, 708")
        try:
        ...
        os.system("clear")
        print (logo)
        print("1, 897, 967, 937, 700, 727, 965, 786, 874, 856, 566, 590, 527, 568, 578")
        try:
            c = raw_input(" choose code  : ")
            k="+9"
            idlist = ('.txt')
